...
introApp.controller( 'AddNameDupesCtrl', function ( $scope ) {
  $scope.names = ['John', 'Dan', 'Tim', 'Andre', 'Angela', 'Maria', 'Andres', 'Chuck', 'Joseph', 'Jose'];
...
introApp.controller( 'HighlightCtrl', function ( $scope ) {
    $scope.names = ['John', 'Dan', 'Tim', 'Andre', 'Angela', 'Maria', 'Andres', 'Chuck', 'Joseph', 'Jose'];
    ...
    $scope.checkFound = function(personName) {
      return $scope.fName && personName.indexOf($scope.fName) > -1;
    }
